...
base.title(bot_name)
base.geometry("400x550")  # Increase the height to 550 to fit the Logout button
...
SendButton = Button(base, font=("Verdana",12,'bold'), text="Send", width="12", height=5,
                    bd=0, bg="#D2B0A2", activebackground="#3c9d9b",fg='#000000',
                    command= send )
...
#Create the box to enter message
EntryBox = Entry(base,textvariable = name_var,bg="#D2B0A2",bd=0,width="29", font="Arial")
...
LogoutButton = Button(base, font=("Verdana", 12, 'bold'), text="Logout", width="12", height=5,
                      bd=0, bg="#D2B0A2", activebackground="#ff4500", fg='#000000',
                      command=base.destroy)

# Place the Logout button on the screen
LogoutButton.place(x=6, y=500, height=30, width=370)
LogoutButton.focus_set()
